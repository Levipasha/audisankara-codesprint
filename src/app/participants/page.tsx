...
import { Search, Filter, User, Users, School, GraduationCap, Crown, Shield } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white border border-slate-200 rounded-3xl shadow-sm">
            ...
            <p className="text-xs text-slate-500 mt-1">Try modifying your search query or college filter.</p>
          </div>
        ) : (
